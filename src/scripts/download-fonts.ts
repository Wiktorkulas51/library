...
// Note: Playfair Display was removed because it is used only by the gold/font-switcher theme,
...
// Weights are downloaded from Fontshare as separate files without unicode-range to reduce cost.
