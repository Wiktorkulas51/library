...
/**
 * Converts email addresses in text into mailto links.
 * Legal content can contain {{COMPANY_EMAIL}}, so email linking happens
 * after HTML escaping to keep the address clickable.
 */
