/**
 * Masks comment contents while preserving line endings and text literals.
 * This keeps line numbers stable in audits and prevents docs from being treated as code.
 */
