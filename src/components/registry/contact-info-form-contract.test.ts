...
// Why: this contract test renders the real Astro component through
// experimental_AstroContainer and checks its HTML structure with Cheerio.
// Reflects a faithful copy of the "CONTACT" section from the lean-creative project
// It reflects the contact section structure with contact boxes on the left
// and a form on the right, using data attributes consumed by the submit script.
