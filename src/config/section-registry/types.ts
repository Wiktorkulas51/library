export type StudioSource = 'starter' | 'heinrich' | 'tom-ros' | 'modern-house' | 'tymoteusz' | 'marek-jodlowski' | 'promix' | 'lean-creative' | 'annawie' | 'stalanowski' | 'klisik' | 'kasia' | 'piekary9' | 'mystek' | 'mentara';
