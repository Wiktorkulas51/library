...
### Warstwowe przejście między sekcjami

Gdy ciemny stats bar ma płynnie przechodzić w jasną sekcję, użyj komponentu `StatsBar.astro` oraz klasy `ui-section-overlap-top` na następnej sekcji. Bar zachowuje pełną szerokość i zaokrąglenie tylko u góry. Jasna sekcja nachodzi na jego dół i ma zaokrąglone górne narożniki.

```astro
---
import StatsBar from "@components/ui/layout/StatsBar.astro";

const stats = [
  { value: "12+", label: "lat doświadczenia" },
  { value: "350", label: "zrealizowanych projektów" },
];
---

<StatsBar stats={stats} />

<Section tone="page" class="ui-section-overlap-top">
  <Container>
